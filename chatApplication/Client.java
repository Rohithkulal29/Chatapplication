...
public class Client implements ActionListener {
    ...
    Client() {
        ...
        // Icons and labels setup
        // (Code for icons omitted for brevity)

        JLabel name = new JLabel("Pavan MC");
        name.setBounds(110, 15, 100, 20);
        name.setForeground(Color.WHITE);
        name.setFont(new Font("SAN_SERIF", Font.BOLD, 14));
        p1.add(name);

        // Initialize chat area panel
        a1 = new JPanel();
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            text.setText(""); // Clear text field after sending
    ...
    // Method to format message panel
